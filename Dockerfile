...
ARG NEXT_PUBLIC_API_PROTOCOL=https
ARG NEXT_PUBLIC_APP_HOST
ARG NEXT_PUBLIC_APP_PROTOCOL=https
ARG NEXT_PUBLIC_NETWORK_NAME
ARG NEXT_PUBLIC_NETWORK_ID
ARG NEXT_PUBLIC_NETWORK_RPC_URL
ARG NEXT_PUBLIC_NETWORK_CURRENCY_NAME
ARG NEXT_PUBLIC_NETWORK_CURRENCY_SYMBOL
ENV NEXT_PUBLIC_API_HOST=$NEXT_PUBLIC_API_HOST
ENV NEXT_PUBLIC_API_PROTOCOL=$NEXT_PUBLIC_API_PROTOCOL
ENV NEXT_PUBLIC_APP_HOST=$NEXT_PUBLIC_APP_HOST
ENV NEXT_PUBLIC_APP_PROTOCOL=$NEXT_PUBLIC_APP_PROTOCOL
